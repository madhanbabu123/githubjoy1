...
downloadCv.addEventListener("click", (e) => {
  ...
  aElement.setAttribute("download", "makesh.pdf");
  aElement.setAttribute("href", "/makesh.pdf");
  aElement.click();
});
...
const progressbar=document.querySelectorAll(".about__progressbar");
  ...
  const progress =bar.CDATA_SECTION_NODE.progress;
  bar.querySelector("span").style.width=progressbar +="%";
 });
